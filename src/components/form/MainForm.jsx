...
const MainContactForm = () => {
  ...
  const isPersonalInfoComplete = () => {
    const { firstName, lastName, email, phone, currentCountry } = formData.personalInfo;
    return firstName && lastName && email && phone && currentCountry && formData.projectStatus;
  };
                  ...
                  {[
                    ...
                    <div
                      ...
                      className={`p-6 bg-white rounded-xl shadow-lg cursor-pointer transform transition-all duration-200 hover:scale-105 ${
                        formData.serviceType === service.value ? 'ring-2 ring-[#039B9B]' : 'border border-gray-200'
                      }`}
                      onClick={() => {
              ...
              <>
                {formData.serviceType === 'installation' && (
                  <InstallationForm
                    ...
                    onFormDataChange={(installationData) => setFormData({
                      ...formData,
                ...
                {formData.serviceType === 'realEstate' && (
                  <RealEstateForm
                    ...
                    onFormDataChange={(realEstateData) => setFormData({
                      ...formData,
                ...
                {formData.serviceType === 'business' && (
                  <BusinessForm
                    ...
                    onFormDataChange={(businessData) => setFormData({
                      ...formData,
          ...
          onFormDataChange={setFormData} />
                    ...
                    <div>
                      <textarea
                        ...
                        placeholder="Please describe the services you need in detail. Include any specific requirements or questions you may have."
