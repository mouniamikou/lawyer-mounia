...
const AcquisitionProcess = () => {
  ...
  return (
    <div className="w-full mx-auto p-4 md:p-8 bg-gradient-to-b from-[#039B9B]/5 to-white rounded-xl shadow-lg">
      <div className="mb-8 md:mb-12">
        ...
        <div className="w-full h-2 bg-[#039B9B]/10 rounded-full mt-6">
          <div 
            className="h-full bg-[#039B9B] rounded-full transition-all duration-300"
      ...
      <div className="grid grid-cols-1 gap-6 md:gap-8">
        <div className="relative mb-8 md:mb-16 overflow-x-auto pb-4 md:pb-0">
              ...
              <div className="space-y-6 md:space-y-8">
                  ...
                  <div className="bg-[#039B9B]/10 rounded-lg p-4 md:p-6">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm md:text-base">{steps[activeStep].tips}</p>
                      </div>
                    </div>
                  </div>
                )}
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    {steps[activeStep].requiredDocs.map((doc, i) => (
