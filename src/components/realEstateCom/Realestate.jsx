      ...
      >
        <motion.div variants={itemVariants} className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Comprehensive legal support and representation for your property transactions,
            ensuring security and peace of mind throughout the process.
          </p>
        </motion.div>
        ...
        <motion.section variants={itemVariants} className="mb-16">
          <div className="flex items-center justify-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-800">Property Sale Services</h2>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
        ...
        <motion.section variants={itemVariants} className="mb-16">
          <div className="flex items-center justify-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-800">Representation Options</h2>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 p-6 border border-gray-100">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-800">In-Person Support</h3>
              </div>
              <p className="text-gray-700">
                Comprehensive support with your physical presence during all key stages
                of the transaction, ensuring complete understanding and control.
              </p>
            </div>
            <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 p-6 border border-gray-100">
              <div className="flex items-center mb-4">
                <LanguagesIcon className="w-8 h-8 text-[#039B9B] mr-3" />
                <h3 className="text-xl font-semibold text-gray-800">Remote Representation</h3>
              </div>
              <p className="text-gray-700">
                Full power of attorney services for clients unable to be present,
                managing all aspects of the transaction on your behalf.
              </p>
            </div>
          </div>
        </motion.section>
