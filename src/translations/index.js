export const translations = {
    fr: {
      ...
      hero: {
        ...
        subtitle: 'Expertise juridique personnalisée pour votre installation réussie au Portugal',
      ...
      about: {
        ...
        paragraphs: [
          ...
          'A la suite d\'un voyage au Portugal, et convaincue par le sentiment de sécurité, la douceur de vivre et l\'hospitalité que j\'y ai trouvé, je m\'y suis installée en 2021.',
      ...
      values: {
        ...
        trust: {
          ...
          points: [
            ...
            'Confidentialité absolue des dossiers',
      ...
      services: {
        title: 'Nos Services',
        installation: {
          title: 'Vous installer au Portugal',
        ...
        realEstate: {
          ...
          description: 'Je structure et sécurise votre transaction.',
          items: [
            'Achat / Vente',
        ...
        business: {
          title: 'Entreprendre',
          description: 'Je vous accompagne dès le lancement de votre activité et reste à vos côtés tout du long',
          items: [
            'Identifications de la structure juridique adéquate',
    ...
    en: {
      ...
      hero: {
        ...
        subtitle: 'Personalized legal expertise for your successful establishment in Portugal',
      ...
      values: {
        ...
        trust: {
          title: 'Trust',
          points: [
            'Guaranteed professional secrecy',
            'Personal data protection',
            'Absolute confidentiality of files',
      ...
      services: {
        ...
        realEstate: {
          ...
          description: 'I structure and secure your transaction.',
          items: [
            'Purchase / Sale',
            'Primary residence',
            'Rental investment',
