...
export const translations = {
  fr: {
    ...
    hero: {
      ...
      subtitle: 'Expertise juridique pour votre installation, création d\'entreprise et investissement immobilier au Portugal',
    ...
    services: {
      ...
      business: {
        ...
        description: 'Lancez votre activité au Portugal en toute sérénité. Accompagnement juridique complet, du choix de la structure à l\'immatriculation.',
        items: [
  ...
  en: {
    ...
    services: {
      ...
      installation: {
        ...
        description: 'Comprehensive legal assistance for your relocation to Portugal. Expert guidance on visas (D7/D2), administrative procedures, and tax optimization',
        items: [
          'NIF Obtention',
          'European Resident',
